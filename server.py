...
lessons = {
    ...
    "6":{
        ...
        "text":"There are three kinds of swords in the sport of fencing:\n\t1. the epee - the heaviest sword,\n\t2. the sabre - a cutting and thrusting weapon derived from the cavalry sword\n\t3. the foil - a light thrusting weapon\n\nThroughout this tutorial we will be focusing on sabre fencing!",
        "media":{"image":"https://imgur.com/43mEIQV.jpg"},
        "keywords":["Epee","sabre","foil","Throughout this tutorial we will be focusing on sabre fencing!"],
        "next_lesson":"7",
    },
    "7":{
        "lesson_id":"7",
    ...
    "11":{
        ...
        "subgroup":"moves",
        "header":"Moves — Strike",        
        "text":"A strike is the initial offensive action made by extending the arm and continuously threatening\nthe opponent's target",
    ...
    "13":{
        ...
        "text":"A parry-riposte occurs when the defender fencer parries an opponent\'s attack\n and counterattacks by hitting the target",
        "media":{"gif":"https://imgur.com/48KRKbZ.gif","slowgif":"https://i.imgur.com/5v6vCdz.gif","image":"https://imgur.com/SOrqjfa.png"},
    ...
    "15":{
        ...
        "subgroup":"moves",
        "header":"Moves — Beat",
        "text":"A beat occurs when the attacker intentionally hits their opponent\'s blade out of line,\n opening space for them to attack",
    ...
    "17":{
        ...
        "subgroup":"priority",
        "header":"Priority",
        "text":"The fencer with priority gets the point, even if both fencers land a touch.\n\nPress next to learn which fencer gets priority in different scenarios.",
        "media":{"gif":"https://imgur.com/ZrMrv6Y.gif","slowgif":"https://i.imgur.com/YLDFda0.gif"},
        "keywords":["priority", "even if both fencers land a touch"],
        "next_lesson":"18",
    },
    "18":{
        "lesson_id":"18",
        ...
        "keywords":["counter-attack", "attack"],
        "next_lesson":"19",
    },
    "19":{
        "lesson_id":"19",
